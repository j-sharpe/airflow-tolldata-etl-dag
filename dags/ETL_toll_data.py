...
dag = DAG(
    ...
    description='Apache Airflow Final Assignement',
...
extract_data_from_tsv = BashOperator(
    ...
    bash_command='cut -f5-7 /home/project/airflow/dags/finalassignment/tollplaza-data.tsv | cut -c1-16 | tr "\t" "," > /home/project/airflow/dags/finalassignment/tsv_data.csv',
    dag=dag,
)

extract_data_from_fixed_width = BashOperator(
    task_id='extract_data_from_fixed_width',
    bash_command='tr -s " " < /home/project/airflow/dags/finalassignment/payment-data.txt | cut -d" " -f11,12 | tr " " "," > /home/project/airflow/dags/finalassignment/fixed_width_data.csv',
    dag=dag,
)
...
transform_data = BashOperator(
    ...
    bash_command='cut -d"," -f4 /home/project/airflow/dags/finalassignment/extracted_data.csv | tr [a-z] [A-Z] > /home/project/airflow/dags/finalassignment/transformed_data.csv',
    dag=dag,
)
